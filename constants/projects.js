export let projects = [
  ...
  {
    name: "animated portfolio Site",
    description:
      "added eye-catching animations and smooth scrolling effects, creating an engaging and memorable user experience. Sass played a crucial role in maintaining a consistent design language throughout the website, ensuring a visually cohesive and professional presentation.",
    about: "added eye-catching animations and smooth scrolling effects",
    techStacks: ["React", "sass", "framer-motion"],
    image: "/animated-portfolio.gif",
    link: "https://pixelportfolio.netlify.app/",
    id: 1,
  },
